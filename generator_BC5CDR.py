...
OUTPUT_RAW_CSV = "Output/output_BC5CDR.csv"
...
PROMPT_TEMPLATE = """Generate synthetic biomedical text similar to BC5CDR, containing mentions of Disease and Chemical entities.
...
- MUST contain at least one Disease or Chemical entity; preferably both.
- Prefer relationships such as treatment, inhibition, causation, or adverse effects.
- Must be biomedical, natural language, moderately complex.
